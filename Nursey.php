        ...
        <section class="cd-hero">
          ...
          <div class="cd-slider-nav">
            <nav>
              ...
              <ul>
                <li class="selected"><a href="#0"><div class="image-icon"><img src="img/about-icon.png"></div><h6>Student</h6></a></li>
          ...
          <div class="col-md-12">
            <div class="content first-content">
              ...
              <div class="primary-button">
                <a href="Nusery/nyonelogin.php">Nursery1</a> &nbsp;
                <a href="Nusery/nytwologin.php">Nursery2</a> &nbsp;  &nbsp;
